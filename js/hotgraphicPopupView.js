define([
    ...
    var HotgraphicPopupView = Backbone.View.extend({
        ...
        events: {
            'click .hotgraphic__popup-done': 'closePopup',
            'click .hotgraphic__popup-controls': 'onControlClick'
        },
        ...
        handleTabs: function() {
            ...
            this.$('.hotgraphic__popup-inner .active').a11y_on(true);
        },
        ...
        applyItemClasses: function(index) {
            this.$('.hotgraphic__item.active').removeClass('active');
            this.$('.hotgraphic__item').filter('[data-index="' + index + '"]').addClass('active');
        },

        handleFocus: function(index) {
            this.$('.hotgraphic__popup-inner .active').a11y_focus(true);
